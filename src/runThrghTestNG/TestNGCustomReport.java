...
public class TestNGCustomReport extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult tr) {
        ScreenShot(tr);
        System.out.println("Finished Executing Test: "+tr.getName()+"Status: Failed"+"\n Reason:"+tr.getThrowable());
    }
    
    @Override
    public void onTestSkipped(ITestResult tr) {
    System.out.println("Skipped test: "+tr.getName()+".Reason"+tr.getThrowable());
    }
    
    @Override
    public void onTestSuccess(ITestResult tr) {
    System.out.println("Finished Executing Test: "+tr.getName()+"Status: Success.");
    }
    ...
    public void ScreenShot(ITestResult result) {
        ...
        try {
            ...
            System.out.println(((TakesScreenshot) BaseClass.driver));
